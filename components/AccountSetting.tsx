    ...
    <div className="col-span-8 overflow-hidden rounded-xl bg-gray-50 px-4 md:px-8 shadow">
      <div className="pt-4">
        ...
        <p className="font- text-slate-600">
          Fill The Following Information To Update Your Account
        </p>
      </div>

      <Sections label="Email Address" content="john.doe@company.com" />
      <Sections label="Username" content="john.doe" />
      <Sections label="Phone number" content="1234567890" />
